...
public class InfoFragment extends android.support.v4.app.Fragment implements PlacesAdapter.PlacesClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_viewi);
        mRecyclerView.hasFixedSize();
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        List<Places> places_list = Places.find(Places.class,"CITY = ? and CATEGORY = ?",""+a,"Info");
